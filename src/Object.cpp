...
//	m_body->m_sceneNode->translate();
//	m_body->m_sceneNode->rotate(m_angularVelocity * deltaTime);
...
float Object::leftOrRight(Vector3& t, float& angle, float speed) {
...
float Object::upOrDown(Vector3& t, float& angle, float speed) {

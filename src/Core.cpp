...
void Core::run() {
	...
	o = ObjectManager::getSingletonPtr()->create("grass #1", ObjectDescManager::getSingletonPtr()->getByName("grass"));
	...
	o = ObjectManager::getSingletonPtr()->create("wall", ObjectDescManager::getSingletonPtr()->getByName("wall"));
	o->setPosition(getTerrainHeightVec(250, 300));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("factory #1", ObjectDescManager::getSingletonPtr()->getByName("factory"));
	o->setPosition(getTerrainHeightVec(320, 200));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("power plant #1", ObjectDescManager::getSingletonPtr()->getByName("power plant, fussion"));
	o->setPosition(getTerrainHeightVec(220, 220));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("power plant #2", ObjectDescManager::getSingletonPtr()->getByName("power plant, geothermal"));
	o->setPosition(getTerrainHeightVec(220, 250));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("light tank #1", ObjectDescManager::getSingletonPtr()->getByName("light tank"));
	o->setPosition(getTerrainHeightVec(230, 200));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("fast light tank #1", ObjectDescManager::getSingletonPtr()->getByName("fast light tank"));
	o->setPosition(getTerrainHeightVec(230, 180));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("human"));

	o = ObjectManager::getSingletonPtr()->create("light tank #2", ObjectDescManager::getSingletonPtr()->getByName("fast light tank"));
	o->setPosition(getTerrainHeightVec(280, 210));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("enemy"));

	o = ObjectManager::getSingletonPtr()->create("light tank #3", ObjectDescManager::getSingletonPtr()->getByName("fast light tank"));
	o->setPosition(getTerrainHeightVec(290, 220));
	o->setPlayer(PlayerManager::getSingletonPtr()->getByName("enemy"));

	o = ObjectManager::getSingletonPtr()->create("kbot #1", ObjectDescManager::getSingletonPtr()->getByName("kbot"));

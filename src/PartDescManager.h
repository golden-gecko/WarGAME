...
//------------------------------------------------------------------------------
		...
		class WeaponDescManager: public ResourceManager<WeaponDesc>, public Ogre::Singleton<WeaponDescManager> {
			...
			public:
				...
				WeaponDesc* create(const string& name, float maxHitPoints, const string& meshName, float maxReloadTime, float turnSpeed, float maxYaw, float maxPitch, float maxPower, WORD maxAmmunition) {
